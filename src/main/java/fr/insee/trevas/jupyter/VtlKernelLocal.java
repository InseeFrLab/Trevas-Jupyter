...
// TODO: avoid duplication after improving Spark conf
public class VtlKernelLocal extends BaseKernel {
    ...
    public VtlKernelLocal() throws Exception {
        spark = SparkUtils.buildLocalSparkSession();
    ...
    public static void main(String[] args) throws Exception {
        ...
        VtlKernelLocal kernel = new VtlKernelLocal();
    ...
    private void registerMethods() throws NoSuchMethodException {
        this.engine.registerMethod("loadParquet", VtlKernelLocal.class.getMethod("loadParquet", String.class));
        this.engine.registerMethod("loadCSV", VtlKernelLocal.class.getMethod("loadCSV", String.class));
        this.engine.registerMethod("writeParquet", VtlKernelLocal.class.getMethod("writeParquet", String.class, Dataset.class));
        this.engine.registerMethod("writeCSV", VtlKernelLocal.class.getMethod("writeCSV", String.class, Dataset.class));
        this.engine.registerMethod("show", VtlKernelLocal.class.getMethod("show", Object.class));
        this.engine.registerMethod("showMetadata", VtlKernelLocal.class.getMethod("showMetadata", Object.class));
        this.engine.registerMethod("size", VtlKernelLocal.class.getMethod("getSize", Dataset.class));
    }
